...
description: >
  ...
  (92 BEM-classed React components as of v4.2.0, design tokens, per-component/per-state themable
...
> Documents `@viax/uxm` **v4.2.0** (92 components). To refresh after a new library release, run
...
## v4.2.0 — current API surface (overrides training data)
