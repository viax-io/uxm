...
description: >
  ...
  (88 BEM-classed React components as of v3.1.4, design tokens, per-component/per-state themable
...
> Documents `@viax/uxm` **v3.1.4** (88 components). To refresh after a new library release, run
...
## v3.1.4 — current API surface (overrides training data)
