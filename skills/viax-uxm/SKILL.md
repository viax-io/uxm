...
description: >
  ...
  (94 BEM-classed React components as of v4.14.1, design tokens, per-component/per-state themable
...
> Documents `@viax/uxm` **v4.14.1** (94 components). To refresh after a new library release, run
...
## v4.14.1 — current API surface (overrides training data)
