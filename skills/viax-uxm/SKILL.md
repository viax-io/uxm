...
description: >
  ...
  (92 BEM-classed React components as of v4.1.2, design tokens, per-component/per-state themable
...
> Documents `@viax/uxm` **v4.1.2** (92 components). To refresh after a new library release, run
...
## v4.1.2 — current API surface (overrides training data)
