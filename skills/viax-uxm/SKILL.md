...
description: >
  ...
  (97 BEM-classed React components as of v4.48.2, design tokens, per-component/per-state themable
...
> Documents `@viax.io/uxm` **v4.48.2** (97 components). The version/count markers are stamped by
...
## v4.48.2 — current API surface (overrides training data)
