...
description: >
  ...
  (89 BEM-classed React components as of v3.3.0, design tokens, per-component/per-state themable
...
> Documents `@viax/uxm` **v3.3.0** (89 components). To refresh after a new library release, run
...
## v3.3.0 — current API surface (overrides training data)
