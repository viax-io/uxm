...
description: >
  ...
  (97 BEM-classed React components as of v4.42.0, design tokens, per-component/per-state themable
...
> Documents `@viax.io/uxm` **v4.42.0** (97 components). The version/count markers are stamped by
...
## v4.42.0 — current API surface (overrides training data)
