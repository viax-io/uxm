...
description: >
  ...
  (94 BEM-classed React components as of v4.18.0, design tokens, per-component/per-state themable
...
> Documents `@viax/uxm` **v4.18.0** (94 components). To refresh after a new library release, run
...
## v4.18.0 — current API surface (overrides training data)
