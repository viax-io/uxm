...
All 94 components exported from `@viax/uxm/ui` (as of v4.14.1), grouped by intent. Use this file
...
| Component | Key exports | What it is |
|-----------|-------------|------------|
| **LifecycleConnector** | `LifecycleConnector`, `LifecycleConnectorProps`, `LifecycleConnectorState`, `LifecycleConnectorRouting` | SVG edge; idle / active / dashed **(unreleased: `dashed-active`** — a dashed edge in the active emphasis, for a selected/hovered future branch**)**; `routing` auto / straight / bezier / orthogonal elbow. |
