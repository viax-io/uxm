  ...
  return (
    <div
      style={{
        ...
        ['--uxm-banner-border-radius' as string]: `${styles.borderRadius}px`,
        borderRadius: 'var(--uxm-banner-border-radius)',
        ['--uxm-banner-padding-y' as string]: `${styles.paddingY}px`,
        ['--uxm-banner-padding-x' as string]: `${styles.paddingX}px`,
        padding: 'var(--uxm-banner-padding-y) var(--uxm-banner-padding-x)',
        ['--uxm-banner-font-size' as string]: `${styles.fontSize}px`,
        fontSize: 'var(--uxm-banner-font-size)',
        display: 'flex',
