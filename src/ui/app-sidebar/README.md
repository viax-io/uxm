...
| Collapsed | `collapsed={true}` | Narrow width (`--collapsed-width`); brand swaps to icon button, labels & headings hide, footer hides, `trailing` hides, `badge` collapses to a corner status dot on the icon tile, item width clamps to 32×32. |
