...
export const themeTokens: ThemeToken[] = [
  // ── Surfaces ──
  { name: 'Surface', variable: 'var(--color-surface)', cssVar: '--color-surface', hex: '#F8F7F6', darkHex: '#232220', group: 'surfaces' },
  { name: 'Surface Alt', variable: 'var(--color-surface-alt)', cssVar: '--color-surface-alt', hex: '#F2F1F0', darkHex: '#2A2927', group: 'surfaces' },
  { name: 'Card', variable: 'var(--color-card)', cssVar: '--color-card', hex: '#FFFFFF', darkHex: '#1B1A18', group: 'surfaces' },
  ...
  // ── Borders ──
  { name: 'Border', variable: 'var(--color-border)', cssVar: '--color-border', hex: '#EBEBEA', darkHex: '#444240', group: 'borders' },
